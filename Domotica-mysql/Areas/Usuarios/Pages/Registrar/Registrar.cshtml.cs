...
using Domotica_mysql.Areas.Usuarios.Controllers;
using System.IO;
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (userList.Count.Equals(0))
                    {
                        ...
                        if (result.Succeeded)
                        {
                            ...
                            await objeto._image.copiarImagenAsync(Input.AvatarImage, objeto._environment, "Usuarios", null);
                            ...
                            {
                                string imageName = Input.AvatarImage.FileName;
                            ...
                            var usuarios = new Domotica_mysql.Data.Usuarios
                            {
                                Nombre = Input.Nombre,
                                ...
                                Imagen = Input.Imagen,
                                Role = Input.Role,
                                //ApplicationUserId es la clave foreign key para saber a que tupla de AspnetUsers corresponde
                                ApplicationUserId = listUser[0].Id
                            };
